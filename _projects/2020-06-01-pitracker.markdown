...
Refer to [`/utils/obj_detector.py`](https://github.com/jwnicholas/PiTracker/blob/master/utils/obj_detector.py) for the implementation details.
...
Refer to [`/utils/tracking.py`](https://github.com/jwnicholas/PiTracker/blob/master/utils/tracking.py) for the implementation details.
